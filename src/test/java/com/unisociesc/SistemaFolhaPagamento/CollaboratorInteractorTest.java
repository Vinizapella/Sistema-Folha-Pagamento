...
import com.unisociesc.SistemaFolhaPagamento.application.usecase.CollaboratorInteractor;
...
class CollaboratorInteractorTest {
    ...
    @Mock
    private SalaryCalculator strategyStandard;

    @Mock
    private SalaryCalculator strategyCommissioned;

    @InjectMocks
    private CollaboratorInteractor service;
